        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><a href="/documentation/features" className="text-gray-400 hover:text-white transition-colors">Features</a></li>
                <li><a href="/documentation/pricing" className="text-gray-400 hover:text-white transition-colors">Pricing</a></li>
                <li><a href="/documentation/integrations" className="text-gray-400 hover:text-white transition-colors">Integrations</a></li>
                <li><a href="/documentation/updates" className="text-gray-400 hover:text-white transition-colors">Updates</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><a href="/documentation/blog" className="text-gray-400 hover:text-white transition-colors">Blog</a></li>
                <li><a href="/documentation/help-center" className="text-gray-400 hover:text-white transition-colors">Help Center</a></li>
                <li><a href="/documentation/guides" className="text-gray-400 hover:text-white transition-colors">Guides</a></li>
                <li><a href="/documentation/api-docs" className="text-gray-400 hover:text-white transition-colors">API Docs</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><a href="/documentation/about-us" className="text-gray-400 hover:text-white transition-colors">About Us</a></li>
                <li><a href="/documentation/careers" className="text-gray-400 hover:text-white transition-colors">Careers</a></li>
                <li><a href="/documentation/legal" className="text-gray-400 hover:text-white transition-colors">Legal</a></li>
                <li><a href="/documentation/contact" className="text-gray-400 hover:text-white transition-colors">Contact</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-wrap space-x-6">
              <a href="/documentation/legal?tab=privacy" className="text-sm text-gray-400 hover:text-white transition-colors">
                Privacy Policy
              </a>
              <a href="/documentation/legal?tab=terms" className="text-sm text-gray-400 hover:text-white transition-colors">
                Terms of Service
              </a>
              <a href="/documentation/legal?tab=cookies" className="text-sm text-gray-400 hover:text-white transition-colors">
                Cookie Policy
              </a>
            </div>
          </div>
