...
/**
 * Static regulation matching logic for fallback
 */
import { safetyRegulationResponses } from '../../../../data/safetyRegulationData';

/**
 * Find matching static regulations from predefined data
 */
export const findStaticRegulationMatch = (query: string): string | null => {
