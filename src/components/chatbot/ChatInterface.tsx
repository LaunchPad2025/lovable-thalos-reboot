...
const ChatInterface = () => {
  ...
  return (
    <div className="flex flex-col h-full bg-[#0F172A] rounded-lg shadow-lg overflow-hidden border border-gray-800">
      <ChatHeader />
      ...
      <div className="border-t border-gray-800 p-3 bg-[#1A1F2C]">
        <div className="mb-3">
          ...
          <div className="flex flex-wrap gap-2">
            <button className="text-xs bg-[#1E293B] text-white px-3 py-1.5 rounded-full hover:bg-[#2D3748]">
