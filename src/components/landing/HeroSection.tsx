  ...
  return (
    <div className="container mx-auto px-4 pt-16 md:pt-24 pb-16 md:pb-20 text-center relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <p className="text-lg md:text-xl text-gray-300 mb-8 md:mb-10 max-w-3xl mx-auto px-2">
        ...
        {/* Trust badges */}
        <div className="flex flex-wrap justify-center gap-4 md:gap-8 text-xs sm:text-sm text-gray-400">
